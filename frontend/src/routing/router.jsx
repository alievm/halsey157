...
const AppRouter = () => (
 <>
  ...
  <footer className="footer-bg bg-white border-t border-gray-200 text-gray-800">
      {/* Основной контейнер */}
      <div className="
      ...
      ">
        ...
        <a href="https://www.schools.nyc.gov/about-us/policies/non-discrimination-policy" className="hover:underline">
